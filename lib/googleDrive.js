...
export async function nahratNaGoogleDrive(bytes, filename, mimeType, slozkaZakazky) {
  ...
  // Multipart tělo se skládá jako skutečná binární data (Buffer), ne jako text
  // s "Content-Transfer-Encoding: base64" — tu hlavičku Google Drive API
  // nerespektuje spolehlivě, takže by se soubor nahrál poškozený nebo vůbec.
